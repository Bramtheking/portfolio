...
// Update projects data with correct links
const projects = [
  {
  ...
  // Featured Projects
  {
    ...
    type: "mobile",
    image: "/assets/images/schaccs-app-screens.png",
    featured: true,
    rating: 4.5,
    downloads: "12K+",
    links: {
  ...
  // AI/ML Projects - Featured
  {
    ...
    aiProject: true,
    links: {
      live: "https://www.academia.edu/124266169/Simulating_Smell_A_Theoretical_Approach_to_Olfactory_Perception_Using_Electromagnetic_Waves",
    },
  },
  {
    ...
    links: {
      live: "https://www.kaggle.com/code/bramwelagina/bramwel",
    },
  },
  {
    title: "PEFRANK SACCO Android App",
    description:
      "Secure cooperative savings application with advanced encryption, transaction history, loan management, and multi-factor authentication. Company policy restricts public access.",
    tech: ["Java", "Android SDK", "SQLite", "Encryption"],
    type: "mobile",
    image: "/assets/images/pefrank-sacco-screens.png",
    rating: 4.6,
    downloads: "15K+",
    links: {},
  },
  // More AI Projects
  {
    ...
    description:
      "Built a robust AI model for safety assessments, integrated seamlessly with Dapper for optimized data handling. This system enables real-time analysis and recommendations. Privately owned.",
  ...
  },
  {
    ...
    description:
      "Designed an AI model to predict gaming session durations based on user behavior data. The model aids in understanding user engagement and optimizing game recommendations. Under development.",
  ...
  },
  {
    ...
    designProject: true,
    links: {
      live: "https://www.figma.com/design/4kU2NKfmL5YWEijEiJO70W/Coffee-Shop-Mobile-App-Design?node-id=0-1&t=tb9DhqQWHkOy4Tpz-1",
    },
  },
  {
    ...
    designProject: true,
    links: {
      live: "https://www.figma.com/design/qhz2JiiViREHisOBP5KOYf/Online-Bike-Shopping-App?node-id=0-1&t=7z44NMIfrW6S8Aih-1",
    },
  },
  {
    ...
    rating: 4.6,
    links: {
      download: "https://drive.google.com/file/d/1EqzwYl-XUOfP6hwRrlKUMhctETF5ridg/view?usp=drive_link",
    },
  },
  ...
  },
  {
    ...
    year: "2025",
    links: {
      live: "https://www.academia.edu/130053956/Hybrid_Technology_Census_Solution_A_Comprehensive_Analysis_of_Modern_Population_Enumeration",
    },
  },
  {
    ...
    year: "2025",
    links: {
      live: "https://www.academia.edu/130053873/Emergent_Consciousness_Through_Associative_Learning_A_Baby_Like_Artificial",
    },
  },
]
                          ...
                          {project.links.live && (
                            ...
                            >
                              <a href={project.links.live} target="_blank" rel="noopener noreferrer">
                                ...
                                {project.designProject ? "View Design" : project.research ? "View Research" : "Live"}
                              </a>
                            </Button>
                          )}
                    ...
                    <CardContent className="p-6">
                      ...
                      {project.research ? (
                        <div className="flex items-center justify-center">
                          <Button
                            size="sm"
                            className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 rounded-xl flex-1"
                            asChild
                          >
                            <a href={project.links.live} target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="flex items-center justify-center">
                          ...
                          >
                            <a href={project.links.live} target="_blank" rel="noopener noreferrer">
                              ...
                              {project.links.live ? "View Project" : "Private"}
                            </a>
                          </Button>
                        </div>
                      ) : Object.keys(project.links).length === 0 ? (
                        <div className="flex items-center justify-center">
                          <div className="px-3 py-2 bg-gradient-to-r from-gray-600 to-gray-700 rounded-xl text-gray-300 text-sm">
                            {project.title.includes("PEFRANK") ? "Company Policy" : "Under Development"}
                          </div>
                        </div>
                      ) : (
